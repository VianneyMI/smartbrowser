...
def get_llm(model_name:all_models_literal)->BaseChatModel:
    ...
    if model_name in google_models_literal:
        return ChatGoogleGenerativeAI(model=model_name)
    elif model_name in anthropic_models_literal:
        return ChatAnthropic(model=model_name)
    elif model_name in openai_models_literal:
        return ChatOpenAI(model=model_name)
    elif model_name in ollama_models_literal:
